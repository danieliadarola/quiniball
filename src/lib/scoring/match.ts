 ...
 *   · Si es destacado y además clava el marcador exacto -> +exactBonus (por
 *     defecto POINTS.exactBonus = 5; la GRAN FINAL usa 10, ver `exactBonusFor`).
 ...
 *                   la GRAN FINAL pasa 10 — ver `exactBonusFor` en types).
 */
